...
export async function runAllOnboardChecks(
  ...
  // (or more, nested) DB connection. On a pooled remote engine (Postgres/
  // Supabase) with a small pool (e.g. GBRAIN_POOL_SIZE=2, the free-tier-safe
  // Supavisor size), running them concurrently exhausts the pool and deadlocks
